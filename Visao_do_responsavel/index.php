...
// 1. Encontra o ID do aluno associado a este responsável (pegando apenas o primeiro, se houver mais de um)
$aluno_info = [];
...
// 2. Busca o número de ocorrências recentes do aluno
$ocorrencias_count = 0;
if (!empty($aluno_info)) {
...
<div class="summary-cards">
    ...
    <a href="ocorrencias_responsavel.php" class="summary-card">
        ...
        <div class="card-content">
            <h3>Ocorrências</h3>
            <p><?php echo $ocorrencias_count; ?> registro(s)</p>
        </div>
    </a>
